  ...
  <view class="template-protocol">
    ...
    <view class="tn-text-center tn-margin tn-text-lg plus-box" :style="{paddingTop: vuex_custom_bar_height + 'px'}">
      <view class="plus-text">
        <view class="tn-text-bold">韵科食谱小程序，开源啦</view>
        <view class="tn-margin-bottom-xl">（会员有更多福利鸭）</view>
      </view>
      
      <view class="plus-text">
        <view class="tn-text-bold">韵科食谱小程序，页面数量50+</view>
      ...
      <view class="plus-text">
        ...
        <view class="tn-margin-bottom-xl">（韵科食谱UI会员免费拥有所有模板）</view>
      </view>
      ...
      <view class="plus-text">
        <view class="tn-text-bold">韵科食谱开始于2022年5月1日，上线于5月30日</view>
      ...
      <view class="plus-text">
        <view class="tn-text-bold">韵科食谱感恩你的支持</view>
