				...
				<view class="login__info tn-flex tn-flex-direction-column tn-flex-col-center tn-flex-row-center">
					...
					<view class="tn-flex login__info__item__button">
						<view class="tn-flex-1 justify-content-item tn-text-center">
							<tn-button v-if="currentModeIndex === 0" shape="round" backgroundColor="tn-cool-bg-color-7--reverse"
								padding="40rpx 0" width="100%" shadow fontBold @click="login()">
								<text class="tn-color-white" hover-class="tn-hover" :hover-stay-time="150">
									登 录
								</text>
							</tn-button>
							<tn-button v-if="currentModeIndex === 1" shape="round" backgroundColor="tn-cool-bg-color-7--reverse"
								padding="40rpx 0" width="100%" shadow fontBold @click="registry()">
								<text class="tn-color-white" hover-class="tn-hover" :hover-stay-time="150">
									注 册
								</text>
							</tn-button>
