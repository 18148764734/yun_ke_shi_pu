    ...
    <view>
      ...
      <view class="king-list tn-margin-top-sm">
        ...
        <view class='king-item tn-color-red tn-icon-circle-fill'>
          ...
          <view class="resume2">
            <text>项目介绍：基于酷炫UI的一套模板，更多详情可微信小程序搜索“韵科食谱”</text>
          </view>
          <view class="resume2">
        ...
        <view class='king-item tn-color-red tn-icon-circle-fill'>
          ...
          <view class="resume2">
            <text>项目介绍：酷炫UI组件库，更多详情可微信小程序搜索“韵科食谱UI”</text>
          </view>
          <view class="resume2">
            <text>职责描述：想法的整理，原型设计，Ul设计，前端界面编程等等</text>
          </view>
        ...
        <view class='king-item tn-color-red tn-icon-circle-fill'>
          ...
          <view class="resume2">
            <text>项目介绍：科技类小程序官网，更多详情可微信小程序搜索“韵科食谱”</text>
          </view>
          <view class="resume2">
